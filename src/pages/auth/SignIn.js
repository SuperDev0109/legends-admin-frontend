        ...
        <main>
            <section className="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
                <div className="container">
                    ...
                    <div className="row justify-content-center form-bg-image" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/assets/img/illustrations/signin.svg)` }}>
                                ...
                                <form action="#" className="mt-4">
                                    ...
                                    <Link to="/dashboard">
                                        <div className="d-grid">
                                            <button type="button" className="btn btn-gray-800">Sign in</button>
                                        </div>
                                    </Link>
                                </form>
