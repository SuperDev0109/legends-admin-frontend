...
const Partnership = () => {
    ...
    const partnerships = useSelector(state => state.auth.partnerships);
        ...
        <div className="py-4">
          ...
          <div className="d-flex justify-content-between w-100 flex-wrap">
            <div className="mb-3 mb-lg-0">
              <h1 className="h4">Partnership</h1>
              <p className="mb-0">
                You can CRUD the Partnerships here
              </p>
            </div>
            {/* <div>
              <a
