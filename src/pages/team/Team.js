...
const Team = () => {
    ...
    const onUpdate = (id, priority, name, role) => {
        setState('update');
        setId(id);
        ...
        <div className="py-4">
          ...
          <div className="d-flex justify-content-between w-100 flex-wrap">
            <div className="mb-3 mb-lg-0">
              <h1 className="h4">Team</h1>
              <p className="mb-0">
                You can CRUD the Team memebers here
              </p>
            </div>
            {/* <div>
              <a
                            ...
                            <tbody>
                                {teams && teams.map((item, index)=> (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <label style={{ cursor: 'pointer' }} onClick={() => onUpdate(`${item._id}`, `${item.priority}`, `${item.name}`, `${item.role}`)}>Edit</label>&nbsp;|&nbsp; 
            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h2 className="h6 modal-title">Team</h2>
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                <div className="mb-4">
                                    ...
                                    <input type="text" className="form-control" id="role" aria-describedby="emailHelp" value={role} onChange={onRoleChange} />
                                </div>
                            </div>
                        </div>
                        <div className='row'>
